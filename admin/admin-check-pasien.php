    ...
    <aside class="sidebar offcanvas-lg offcanvas-start">
      ...
      <nav class="menu flex-fill">
        <div class="section-menu">
          <a href="admin-dashboard.php" class="item-menu" onclick="handleClickMenu(this)">
            <svg 
            fill="currentColor" 
          ...
          <a href="admin-check-pasien.php" class="item-menu active" onclick="handleClickMenu(this)">
                ...
                <td>
                    <?php
                        if($fetch['status']=='pending'){
                            echo "<a href=/clinic-system/admin/functions/admin-action-accept.php?id_periksa=".$fetch['id_periksa']." class='btn btn-success btn-block'>Accept</a>";
                            echo "<a href=/clinic-system/admin/functions/admin-action-reject.php?id_periksa=".$fetch['id_periksa']." class='btn btn-danger btn-block'>Reject</a>";
                        }else if($fetch['status']=='accepted'){
                            echo "<a href=/clinic-system/admin/functions/admin-action-done.php?id_periksa=".$fetch['id_periksa']." class='btn btn-primary btn-block'>Done</a>";
                        }else{
