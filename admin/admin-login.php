...
if(isset($_POST["admin-login"])) {
    ...
    if (count($errors) == 0) {
      $psswrd = md5($password);
      $sql = "SELECT * FROM tb_admins WHERE username='$username' AND password='$psswrd'";
  ...
  <div class="card mx-4 mx-md-5 shadow-5-strong" style="
    ...
    <div class="card-body py-5 px-md-5">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-8">
          <h2 class="fw-bold mb-5">Admin Staff Login</h2>
          ...
          <?php include '../errors.php'; ?>
            ...
            <!-- Submit button -->
            <button type="submit" class="btn btn-primary btn-block mb-4" name="admin-login">
              Login
            </button>
