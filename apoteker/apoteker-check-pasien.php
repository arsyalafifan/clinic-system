      ...
      <div class="container">
        ...
        <table id="example" class="table table-responsive-sm table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                ...
                <th class="th-sm">Dokter
                </th>
                <th class="th-sm">Keluhan
                </th>
                <th class="th-sm">Diagnosa
                </th>
                <th class="th-sm">Tindakan
                </th>
                <th class="th-sm">Tambah Obat
                </th>
                </tr>
            </thead>
            <tbody>
            <?php
                ...
                if(isset($_POST['cari-pasien'])){
                    ...
                    $no = 1;
                    $sql = "SELECT * FROM hasil_pemeriksaan_dokter WHERE id_periksa = '$id_periksa'";
            ...
            <tr>
                ...
                <td><?php echo $fetch['username_pasien']?></td>
                <td><?php echo $fetch['dokter']?></td>
                <td><?php echo $fetch['keluhan']?></td>
                <td><?php echo $fetch['diagnosa']?></td>
                <td><?php echo $fetch['tindakan']?></td>
                <td>
                    <a href="apoteker-tambah-obat.php?id_periksa=<?php echo $fetch['id_periksa'] ?>" class="btn btn-primary">Tambah Obat</a>
                </td>
            </tr>
