<?php
  ...
  if (!isset($_SESSION['apoteker_username'])) {
  	$_SESSION['msg'] = "You must log in first";
  	header('location: apoteker-login.php');
  }
  if (isset($_GET['logout'])) {
  	session_destroy();
  	unset($_SESSION['apoteker_username']);
  	header("location: apoteker-login.php");
  }
?>
...
<body>
    <aside class="sidebar offcanvas-lg offcanvas-start">
      ...
      <nav class="menu flex-fill">
        <div class="section-menu">
          <a href="apoteker-dashboard.php" class="item-menu active" onclick="handleClickMenu(this)">
            <svg 
            fill="currentColor" 
          ...
          <a href="apoteker-check-pasien.php" class="item-menu" onclick="handleClickMenu(this)">
    ...
    <main class="content flex-fill">
      ...
      <section class="d-flex flex-column gap-4">
        <div class="d-flex justify-content-between align-items-center gap-3">
          <h4 class="title-section-content">Apoteker Statistics</h4>
        </div>
        ...
        ?>
          <div class="product-card">
            ...
            <div class="product-detail pt-4">
              <div>
                <h5>Total Pasien:</h5>
                <p style="font-size:48px;" class="price-detail"><?php echo $rowcount . ' pasien' ?></p>
        ...
        ?>
          <div class="product-card">
            ...
            <div class="product-detail pt-4">
              <div>
                <h5>Total Obat yang tersedia:</h5>
                <p style="font-size:48px;" class="price-detail"><?php echo $rowcount . ' jenis' ?></p>
                <a class="btn btn-warning text-white" href="user-riwayat-berobat.php">Lihat Detail</a>
              </div>
        <?php
            }
    ...
    <a href="apoteker-dashboard.php?logout='1'">Logout</a>
    <?php  if (isset($_SESSION['apoteker_username'])) : ?>
    	<p>Welcome <strong><?php echo $_SESSION['apoteker_username']; ?></strong></p>
    <?php endif ?>
    <a href="apoteker-check-pasien.php">Cek Pasien</a>
