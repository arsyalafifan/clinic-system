<?php
  ...
  if (!isset($_SESSION['dokter_username'])) {
...
<body>
    <aside class="sidebar offcanvas-lg offcanvas-start">
      ...
      <nav class="menu flex-fill">
        <div class="section-menu">
          <a href="dokter-dashboard.php" class="item-menu active" onclick="handleClickMenu(this)">
            <svg 
            fill="currentColor" 
          ...
          <a href="dokter-check-pasien.php" class="item-menu" onclick="handleClickMenu(this)">
    ...
    <main class="content flex-fill">
      ...
      <section class="d-flex flex-column gap-4">
        <div class="d-flex justify-content-between align-items-center gap-3">
          <h4 class="title-section-content">Dokter Statistics</h4>
        </div>
        <div class="d-flex gap-4 flex-wrap">
        <?php
            include '../database_configuration/config_db.php';
            $sql = "SELECT * FROM hasil_pemeriksaan_dokter";
    ...
    <a href="dokter-dashboard.php?logout='1'">Logout</a>
    <?php  if (isset($_SESSION['dokter_username'])) : ?>
    	<p>Welcome <strong><?php echo $_SESSION['dokter_username']; ?></strong></p>
    <?php endif ?>
    <a href="dokter-check-pasien.php">Cek Pasien</a>
