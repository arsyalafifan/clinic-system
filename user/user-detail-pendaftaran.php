    ...
    <main class="content flex-fill">
      ...
      <section>
            <?php
                    ...
                    $id = $_GET['id_periksa'];
                    $sql = "SELECT * FROM periksa ORDER BY id_periksa DESC LIMIT 1";
                ...
                <div class="container container-lg" method="post">
                    <div class="purchase pt-md-50 pt-30">
                        <h2 class="fw-bold text-xl mb-4">Bukti Pendaftaranmu:</h2>
                        ...
                        <p class="text-lg mb-4">Tanggal Periksa<span class="purchase-details"><?php echo $fetch['tgl_periksa'] ?></span></p>
                        <p class="text-lg mb-4">Waktu<span class="purchase-details"><?php echo $fetch['waktu'] ?></span></p>
      ...
      <?php
        ...
        <div class="container container-lg" method="post">
            <div class="purchase pt-md-50 pt-30">
                ...
                <p class="text-lg mb-30">Username<span class="purchase-details"><?php echo $fetch['username_pasien'] ?></span></p>
                <p class="text-lg mb-30">Dokter<span class="purchase-details"><?php echo $fetch['dokter'] ?></span></p>
                <p class="text-lg mb-30">Keluhan<span class="purchase-details"><?php echo $fetch['keluhan'] ?></span></p>
                <p class="text-lg mb-30">Diagnosa<span class="purchase-details"><?php echo $fetch['diagnosa'] ?></span></p>
                <p class="text-lg mb-30">Tindakan<span class="purchase-details"><?php echo $fetch['tindakan'] ?></span></p>
                <p class="text-lg mb-30">Obat<span class="purchase-details"><?php echo $fetch['obat'] ?></span></p>
                <p class="text-lg mb-30">Tanggal Berobat<span class="purchase-details"><?php echo $fetch['tgl_berobat'] ?></span></p>
