...
<body>
    <aside class="sidebar offcanvas-lg offcanvas-start">
      ...
      <nav class="menu flex-fill">
        <div class="section-menu">
          <a href="user-dashboard.php" class="item-menu active" onclick="handleClickMenu(this)">
            <svg 
            fill="currentColor" 
	...
	<div class="row text-center">
        <div class="col ol-sm-offset-3">
        <i class="fa-regular fa-circle-check fa-7x mb-4"></i>
        <!-- <svg class="fa-7x"
            fill="#0fad00" 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 512 512">
        ...
        <h3 class="mb-4">Pendaftaranmu telah berhasil</h3>
        <p class="mb-4" style="font-size:20px;color:#5C5C5C;">Terima kasih telah mendaftar, silakan datang tepat waktu dan tunjukkan id pendaftaranmu kepada admin clinic.</p>
        <!-- Button trigger modal -->
        <a type="button" class="btn btn-primary" href="user-detail-pendaftaran.php">
            Details
        </a>
    <br><br>
        </div>
    ...
    <?php endif ?>
    <a href="user-periksa.php">Daftar Berobat</a>
    <a href="user-riwayat-berobat.php">Riwayat Berobat</a>
